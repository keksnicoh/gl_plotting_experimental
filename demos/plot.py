...
if __name__ == '__main__':
    ...
    r_max = 32.0    # max r value
    y_size = 64.0   # size of the y axis
    origin_y = 32.0 # posizion of origin_y on y axis
    ...
    data = {
        'main': {
            'points': bifurk(kernel_sin, r_min=r_min, r_max=r_max, n=10000),
        },
