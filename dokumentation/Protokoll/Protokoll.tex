...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.4]{log-konv-r3}
\includegraphics[scale=0.4]{log-bifurc-umr3}
...
\label{fig:log-konv1}
\end{figure}
Der Bereich um den Bifurkationspunkt ist in Abbildung \ref{fig:log-konv1} (rechts) dargestellt. Dabei wurde zunächst OpenCL für die Berechnung verwendet, was zu einem ungenauem Ergebnis führt. Es lässt sich nur Grob ablesen, dass bei ca. $r=3$ der Fixpunkt $x_1$ instabil.
