...
1. OpenGL Shader. Die VBO Objekte werden in Python initialisiert (x,y). Der Vertex- oder Fragmentshader bildet diese Punkte dann direkt ab. Mittels einer Translations- und Skalierungsmatrix können beim bewegen durch die Plotplane die (x,y) so transformiert werden, dass beim zoomen und beim translatieren im Plot stets gleich viele Punkte abgebildet werden. 

2. OpenCL Kernel. Die VBO Objekte werden via OpenCL mit Daten befüllt. 

3. Direktes eingeben von Plotdaten, (z.B. Textfile, Fortran, Python).

Vor allem waren wir von dem Potential der Variante 1. begeistert. Beispielsweise konnte mit einem Fragmentshader Plot sehr einfach eine Abbildung im komplexen Raum farbig visualisiert werden. 
